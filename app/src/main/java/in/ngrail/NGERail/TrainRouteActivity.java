                    ...
                    if (jsonobj.getString("response_code").equals("200")) {
                        ...
                        for(int i=0; i<totalcnt; i++)
                        {
                            ...
                            if(i==0)
                            {
                                ...
                                if (Build.VERSION.SDK_INT >= 23) {
                                    tv5[i].setTextColor(getResources().getColor(R.color.colorAccent,getApplicationContext().getTheme()));
                                }else {
                            ...
                            tv5[i].setTypeface(Typeface.create("sans-serif-condensed", Typeface.NORMAL));
                            if (Build.VERSION.SDK_INT >= 23) {
                                tv5[i].setTextColor(getResources().getColor(rrg,getApplicationContext().getTheme()));
                            }else {
